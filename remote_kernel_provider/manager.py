...
from .processproxy import RemoteProcessProxy, LocalProcessProxy
...
class RemoteKernelManager(KernelManagerABC):
    ...
    def __init__(self, **kwargs):
        ...
        self.proxy_info = kwargs.get('proxy_info')
    ...
    def launch(cls, **kwargs):
        ...
        return kernel_manager.process_proxy.connection_info, kernel_manager
    ...
    def start_kernel(self):
        ...
        process_proxy_class_name = self.proxy_info.get('class_name')
        ...
        self.process_proxy = process_proxy_class(kernel_manager=self, proxy_config=self.proxy_info.get('config', {}))
        ...
        self.kernel = self.process_proxy.launch_process(kernel_cmd, env=self.env)
